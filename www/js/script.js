...
if($.fn.fullpage){
    ...
    //             var svg_dom=domParser.parseFromString(resp,"text/xml");
    //             var svg_el=svg_dom.getElementsByTagName("svg")[0];
    //             svg_el.setAttribute("class",$class);
    //             item.outerHTML=(new XMLSerializer()).serializeToString(svg_el);
    //
    //         })
    // });
    // $(".service__grid img[src$='svg']").each(function () {
    //     var $img = $(this);
    //     var s=this;
    ...
    //             $svg = $svg.attr('class', $class + ' replaced-svg');
    //         }
    //         //
    ...
    //         }
    //         $svg.attr("id", "svgid" + Math.random());
    //         $img.replaceWith($svg);
    //         // // Replace image with new SVG
    //         // serialize=new XMLSerializer();
    //         // // console.log(data.getEl)
    //         // s.outerHTML=serialize.serializeToString(data.getElementsByTagName("svg")[0]);
    //     }, "xml");
    // })
});
